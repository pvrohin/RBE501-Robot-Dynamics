...
for jj = 1 : nPts - 1
    ...
    for ii = 1 : size(t,2) - 1
        ...
        params_rne.Ftip = zeros(6,1);%[0 0 9.81 0 0 0]';%zeros(6,1); % end effector wrench [0 0 9.81 0 0 0]
        ...
        params_fdyn.Ftip = zeros(6,1);%[0 0 9.81 0 0 0]';%zeros(6,1); % end effector wrench [0 0 9.81 0 0 0]
